import { z } from 'zod';
export function registerArtifactTools(server, artifactManager) {
    server.registerTool('invoke_save_artifact', {
    ...
    server.registerTool('invoke_read_artifact', {
    ...
    server.registerTool('invoke_delete_artifact', {
