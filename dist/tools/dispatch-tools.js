...
export function registerDispatchTools(server, engine, batchManager, projectDir, metricsManager, sessionManager) {
    ...
    server.registerTool('invoke_get_prior_findings_for_builder', {
        ...
        inputSchema: z.object({
            session_id: z.string(),
            batch_id: z.number().optional().describe('Optional — when set, only returns findings from cycles with this batch_id. Use for inter-batch review fix dispatches.'),
        }),
