import { z } from 'zod';
export function registerContextTools(server, contextManager) {
    server.registerTool('invoke_get_context', {
    ...
    server.registerTool('invoke_update_context', {
    ...
    server.registerTool('invoke_init_context', {
